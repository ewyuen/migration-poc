...
Define how the verification stage executes Reqnroll BDD tests (`.feature` files bound to `StepDefinitions.cs`) and reports results, coverage, and errors back through the orchestrator pipeline.
