...
Define the two LangGraph nodes (`step_defs_template`, `step_defs_enhance`) that generate and enhance Reqnroll step definitions, and the `MigrationState` fields they read and write.
